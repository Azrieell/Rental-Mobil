    ...
    <div class="card bg-white">
        <div class="row mb-4">
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="footer-text pull-left">
                    ...
                    <p class="card-text">Jasa Penyewaan Mobil</p>
            ...
            <div class="col-md-2 col-sm-2 col-xs-2">
                <h5 class="heading">Menyediakan Jasa</h5>
                <ul class="card-text">
                    <span>Penyewaan Mobil</span> <span>Penyedia Jasa Pariwisata</span>
                </ul>
            </div>
        </div>
        ...
        <div class="row" style="font-size:10px;">
            <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="pull-left">
                    <p><i class="fa fa-copyright"></i> 2023 Azriel R Siddiq</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6">
            </div>
